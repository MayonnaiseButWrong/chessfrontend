import './OnePlayerChargeOfTheLightBrigadeChess.css'
...
const OnePlayerChargeOfTheLightBrigadeChess = () => {
    ...
    return (
        <div className="ChessFrontEnd">
            <h1>Charge Of The Light Brigade Chess</h1>
...
export { OnePlayerChargeOfTheLightBrigadeChess };